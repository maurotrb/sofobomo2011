...
\ParallelLText{
    \begin{english}[variant=american]
        ...
        Your are walking in a little wood called \emph{Selva delle Grazie}.
...
\ParallelRText{
    \begin{italian}
        ...
        Stai camminando in un piccolo bosco chiamato la Selva delle Grazie.
...
\ParallelLText{
    \begin{english}[variant=american]
        ...
        this period. But outside few rich Italian cities the application of the edict was
        much slower.}.
        ...
        The definitive site was decide in the 1869 and the cemetery opened in 1871.
...
\ParallelRText{
    \begin{italian}
        ...
        Con la nuova legge, si avvio un Rinascimento nella progettazione e nell'architettura dei cimiteri.
...
\ParallelRText{
    \begin{italian}
        ...
        la loro forma, il loro stile, le loro condizioni.
    \end{italian}
}
\ParallelPar
\ParallelLText{
...
\ParallelRText{
    \begin{italian}
        \textbf{Decorazioni}.
        Semplici come una donna che piange. Complesse e con molti simboli.
...
\ParallelLText{
    \begin{english}[variant=american]
        ...
        Unfortunately they are only in italians. See the column at the right.
    \end{english}
}
\ParallelRText{
    \begin{italian}
...
\ParallelRText{
    \begin{italian}
        ...
        MISCELLANEA SENIGALLIESE 18152.
    \end{italian}
}
\ParallelPar
\end{Parallel}
